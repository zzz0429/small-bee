...
import NewWineOld from '@/components/cake/fenlei/NewWineOld'
import NewWineChildren from '@/components/cake/fenlei/NewWineChildren'
import NewWineGravida from '@/components/cake/fenlei/NewWineGravida'
import NewWineLovers from '@/components/cake/fenlei/NewWineLovers'

import NewNutOld from '@/components/cake/fenlei/NewNutOld'
import NewNutChildren from '@/components/cake/fenlei/NewNutChildren'
import NewNutGravida from '@/components/cake/fenlei/NewNutGravida'
import NewNutLovers from '@/components/cake/fenlei/NewNutLovers'

import NewCreamOld from '@/components/cake/fenlei/NewCreamOld'
import NewCreamChildren from '@/components/cake/fenlei/NewCreamChildren'
import NewCreamGravida from '@/components/cake/fenlei/NewCreamGravida'
import NewCreamLovers from '@/components/cake/fenlei/NewCreamLovers'

import NewFruitsOld from '@/components/cake/fenlei/NewFruitsOld'
import NewFruitsChildren from '@/components/cake/fenlei/NewFruitsChildren'
import NewFruitsGravida from '@/components/cake/fenlei/NewFruitsGravida'
import NewFruitsLovers from '@/components/cake/fenlei/NewFruitsLovers'
  ...
  routes: [
    {
      ...
      children: [
        ...
        {
          path: '/cake/new/wine/old',
          name: 'NewWineOld',
          component: NewWineOld,
        },
        {
          path: '/cake/new/wine/children',
          name: 'NewWineChildren',
          component: NewWineChildren,
        },
        {
          path: '/cake/new/wine/gravida',
          name: 'NewWineGravida',
          component: NewWineGravida,
        },
        {
          path: '/cake/new/wine/lovers',
          name: 'NewWineLovers',
          component: NewWineLovers,
        },
        {
          path: '/cake/new/nut/old',
          name: 'NewNutOld',
          component: NewNutOld,
        },
        {
          path: '/cake/new/nut/children',
          name: 'NewNutChildren',
          component: NewNutChildren,
        },
        {
          path: '/cake/new/nut/gravida',
          name: 'NewNutGravida',
          component: NewNutGravida,
        },
        {
          path: '/cake/new/nut/lovers',
          name: 'NewNutLovers',
          component: NewNutLovers,
        },
        {
          path: '/cake/new/cream/old',
          name: 'NewCreamOld',
          component: NewCreamOld,
        },
        {
          path: '/cake/new/cream/children',
          name: 'NewCreamChildren',
          component: NewCreamChildren,
        },
        {
          path: '/cake/new/cream/gravida',
          name: 'NewCreamGravida',
          component: NewCreamGravida,
        },
        {
          path: '/cake/new/cream/lovers',
          name: 'NewCreamLovers',
          component: NewCreamLovers,
        },


        {
          path: '/cake/new/fruits/old',
          name: 'NewFruitsOld',
          component: NewFruitsOld,
        },
        {
          path: '/cake/new/fruits/children',
          name: 'NewFruitsChildren',
          component: NewFruitsChildren,
        },
        {
          path: '/cake/new/fruits/gravida',
          name: 'NewFruitsGravida',
          component: NewFruitsGravida,
        },
        {
          path: '/cake/new/fruits/lovers',
          name: 'NewFruitsLovers',
          component: NewFruitsLovers,
        },
